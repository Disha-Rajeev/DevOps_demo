...
This is a simple Expense Tracker web application built using **Flask** with SQLite as the database. It allows users to manage their expenses with features like adding, updating, and deleting expenses. The app also calculates the total expense and provides the option to download expenses in PDF format.
...
The database file expenses.db will be generated inside the instance/ folder.
